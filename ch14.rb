...
build_array_of_sqaures = Proc.new do |array|
...
puts do_until_false([5], build_array_of_sqaures).inspect

yum = 'lemondate with a hunt of orange blossom water'
